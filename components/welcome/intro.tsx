  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Welcome to{" "}
          <span className="font-bold tracking-tighter">DocumentWave</span>
        </motion.h1>
        <motion.p
          className="max-w-md text-accent-foreground/80 transition-colors sm:text-lg"
          variants={STAGGER_CHILD_VARIANTS}
        >
          DocumentWave revolutionizes document sharing with intelligent analytics,
          enterprise security, and seamless collaboration workflows.
        </motion.p>
        <motion.div
          variants={STAGGER_CHILD_VARIANTS}
