...
export function constructMetadata({
  ...
  description = "DocumentWave is the intelligent document sharing platform that revolutionizes how teams collaborate. Enterprise-grade security, powerful analytics, and seamless workflows.",
  image = "https://www.documentwave.app/_static/meta-image.png",
  favicon = "/favicon.ico",
  noIndex = false,
}: {
  title?: string;
